...
class AppColor {
  ...
  static Color homePageDetail = const Color(0xFF5488f4);
  ...
  static Color secondPageContainerGradient1stColor = const Color(0xFF777CE3);
  static Color secondPageContainerGradient2ndColor = const Color(0xFF989CE1);
